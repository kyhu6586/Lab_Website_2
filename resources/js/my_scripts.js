...
*/
 function loadStatsPage(){
		...
		{//Outer for loop iterates over each row
			...
			ourScore=parseInt(table.rows[row_counter].cells[2].innerHTML,10);
			oppScore=parseInt(table.rows[row_counter].cells[3].innerHTML,10);
...
/*
	Football Player Information Page
		loadPlayersPage method:
			...
			purpose: This method willpopulate the dropdown menu to allow the
...
function switchPlayers(playerID){
	...
	document.getElementById("avg_p_yards").innerHTML=Math.ceil((player.pass_yards)/(player.games_played));
	document.getElementById("avg_r_yards").innerHTML=Math.ceil((player.rushing_yards)/(player.games_played));
	document.getElementById("avg_rec_yards").innerHTML=Math.ceil((player.receiving_yards)/(player.games_played));
